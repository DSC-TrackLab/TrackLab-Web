...
<div class="container profile">
    ...
    <div class="text-center">
        <div class='profile_pic'>
            <svg width="9em" height="9em" viewBox="0 0 16 16" class="bi bi-truck" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class='vehicle'>
            ...
            <p class='d-inline'>Motobike</p>
            <p>Has been driving for 2 years</p>
        </div><hr/>
        <div class='contact'>
            <h5>Contact</h5>
